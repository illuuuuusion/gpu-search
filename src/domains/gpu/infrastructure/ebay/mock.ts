...
import { extractListingIdentity } from '../../domain/listingSignals.js';
...
function buildMockListingsForProfile(profile: GpuProfile, baseSequence: number): EbayListing[] {
...
export async function searchMockBucketListingsPage(
  bucket: SearchBucket,
  profiles: GpuProfile[],
  offset: number,
  limit: number,
