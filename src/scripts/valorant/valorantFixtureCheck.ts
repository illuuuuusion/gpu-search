...
import { extractVlrEventCards, parseVlrEventImport, type VlrEventCard } from '../../domains/valorant/providers/vlr/provider.js';
...
function run(): void {
  ...
  const parsed = parseVlrEventImport(mastersCard as VlrEventCard, agentsFixtureHtml, new Date('2026-06-22T12:00:00.000Z'));
