...
import { ActionRowBuilder, ActivityType, ButtonBuilder, ButtonStyle, Client, DiscordAPIError, EmbedBuilder, Events, GatewayIntentBits, ModalBuilder, MessageFlags, Partials, PermissionFlagsBits, SlashCommandBuilder, StringSelectMenuBuilder, TextInputBuilder, TextInputStyle, } from 'discord.js';
...
export class DiscordNotifier {
    ...
    reactionRouter = new ReactionRouter();
    nextSendAt = 0;
    readyPromise = null;
    ...
    async postBiasAdjustment(event, profileName, previousBias, bias) {
        const info = await event.reaction.message.reply({
